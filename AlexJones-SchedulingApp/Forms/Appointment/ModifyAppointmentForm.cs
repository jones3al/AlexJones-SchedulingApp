...
namespace AlexJones_SchedulingApp {
    public partial class ModifyAppointmentForm : SaveableForm {
        ...
        private void OnCustomerChanged(object sender, EventArgs e) {
            lblCustomerName.Text = $"Customer: {DBHelper.GetCustomerById(int.Parse(cmbCustomerId.SelectedItem.ToString())).Name}";
        }
        private void OnUserChanged(object sender, EventArgs e) {
            lblUserName.Text = $"Username: {DBHelper.GetUserById(int.Parse(cmbUserId.SelectedItem.ToString())).Username}";
        }
        ...
        private void OnSaveButtonClicked(object sender, EventArgs e) {
            ...
            try {
                ...
                // Created a new appointment using the form data, parse that object into a INSERT INTO .. VALUES string and use DBHelper to push it
                ...
                DateTime createDate = currentAppointment.CreatedDate.ToUniversalTime();
                ...
                int rowsAffected = DBHelper.UpdateRecord("appointment", insertValues, $"appointmentId = {appointmentId}");
