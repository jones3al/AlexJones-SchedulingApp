...
namespace AlexJones_SchedulingApp
{
    public partial class NewAppointmentForm : SaveableForm {
        ...
        private void NewAppointmentForm_Load(object sender, EventArgs e) {
            ...
            tboxAppointmentId.Text = DBHelper.GetNewIdFromTable("appointment", "appointmentId").ToString();
        ...
        private void OnSaveButtonPressed(object sender, EventArgs e) {
            ...
            try {
                ...
                int rowsAffected = DBHelper.InsertNewRecord("appointment", insertValues);
