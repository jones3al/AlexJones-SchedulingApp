...
namespace AlexJones_SchedulingApp
{
    public partial class NewAddressForm : SaveableForm {
        ...
        private void ResetForm() {
            ...
            tboxAddressId.Text = DBHelper.GetNewIdFromTable("address", "addressId").ToString();
        ...
        private void OnSaveButtonClicked(object sender, EventArgs e) {
            ...
            string insertValues = $"{newAddress.Id}, \"{newAddress.Address1}\", \"{newAddress.Address2}\", {newAddress.CityId}, \"{newAddress.PostalCode}\", \"{newAddress.Phone}\", \"{newAddress.CreatedDate:yyyy-MM-dd HH:mm:ss}\", \"{newAddress.CreatedBy}\", " +
                $"\"{newAddress.LastUpdatedDate:yyyy-MM-dd HH:mm:ss}\", \"{newAddress.LastUpdatedBy}\"";

            // Use DBHelper to attempt to Insert new record
            int rowsAdded = DBHelper.InsertNewRecord("address", insertValues);
