...
namespace AlexJones_SchedulingApp
{
    public partial class SelectAddressForm : Form {
        ...
        public SelectAddressForm(User user) {
            InitializeComponent();
        ...
        private void ResetForm() {
            ...
            List<Address> allAddresss = DBHelper.GetAllAddresses();
        ...
        private void SetDetailsWindow(Address address) {
            ...
            entryBuilder.Append($"\r\n");
            entryBuilder.Append($"Date Created: {address.CreatedDate}");
            entryBuilder.Append($"\r\n");
            entryBuilder.Append($"Created By: {address.CreatedBy}");
            entryBuilder.Append($"\r\n");
            entryBuilder.Append($"Date Last Updated: {address.LastUpdatedDate}");
            entryBuilder.Append($"\r\n");
        ...
        private void OnNewAddressSelected(object sender, EventArgs e) {
            Address selectedAddress = DBHelper.GetAddressById(int.Parse(cmbAddressId.SelectedItem.ToString()));
        ...
        private void OnModifyButtonClicked(object sender, EventArgs e) {
            ...
            Address selectedAddress = DBHelper.GetAddressById(addressId);
        ...
        private void OnDeleteButtonClicked(object sender, EventArgs e) {
            ...
            if(confirmMessage == DialogResult.Yes) {
                ...
                int rowsAffected = DBHelper.DeleteRecord("address", $"addressId = {int.Parse(cmbAddressId.SelectedItem.ToString())}");
